...
var hora=fecha.getHours()+":"+fecha.getMinutes();
    ...
    if (hh1<hh2 || (hh1==hh2 && mm1<mm2)){
        alert(hora +" MENOR "+ horaC +"configure la cantidad de los platos y las presas");
        $("#page-wrapper").load('configurar_plato.php');}
    else if (hh1>hh2 || (hh1==hh2 && mm1>mm2))
        alert(hora+" MAYOR "+ horaC +": ya no puede Ingresar a la configuracion de los productos");
    else 
        alert(hora +" IGUAL "+ horaC +": configure la cnatidad de los platos"); 
    });
