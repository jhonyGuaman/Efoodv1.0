...
socket.on('notification', function (data) {
  ...
  if (con_a !=con ) {
      ...
      if (con2 != 0) {
        ...
        console.log("con2 vale"+con2 )
        $("#numpedi").removeClass("label label-primary");
        $("#numpedi").html("");
        $("#numpedi2").removeClass("label label-primary")
        $("#numpedi2").html("");
        $("#numpedi3").html(con2);
