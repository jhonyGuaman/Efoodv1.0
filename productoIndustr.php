  ...
  <div class="panel-body">                         <!-- PANEL SECUNDARIO -->
      ...
      <div class="col-md-4">
            ...
            <div class="form-group">
                <label><input type="radio" name="iva" id="iva0" value="0 %" >   0 %</label> <br>
...
<div class="row">
<div class="col-md-6">
<button type="button" class="btn btn-danger" id="btn_producto2"> Guardar <i class="fa fa-floppy-o "></i></button>
</div>
</div>