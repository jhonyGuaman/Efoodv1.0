...
<script src="Controlador/control_productos.js"></script>
<!--FIN DE LIBRERIAS -->
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">
        ...
        Administración de productos industrializados
      </h1>
    </div>
  </div>
  <!-- /.row -->
    ...
    <div class="box-body">
      ...
      <div class="col-xs-4">
        <div class="input-group  input-group-sm">
          <input type="text"name="buscar_bebidas" id="buscar_bebidas" class="form-control" onkeyup="lista_productos(this.value);" placeholder="Ingrese Nombre o Categoria">
  ...
  <div id="lista_productos">
    <?php
    include('adminProductos/consulta_productos.php');
    ?>
  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title">Datos del Producto Industrializado </h2>
        </div>
          ...
          <form class="form-horizontal" id="formplatos">
            <div class="form-group">
              ...
              <div class="col-xs-5">
                ...
                <input id="idproducto" name="idproducto" type="text" class="form-control" placeholder="Ingrese ISBN" disabled="false">
              </div>
            </div>
            <div class="form-group">
              <label for="titulo" class="control-label col-xs-5">Nombre de la producto :</label>
              <div class="col-xs-5">
                <input id="nombre_producto" name="nombre_producto" type="text" class="form-control" placeholder="Ingrese su Nombre">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
            <label for="precio" class="control-label col-xs-5" >Iva : </label>
            <div class="col-xs-5">
                <label><input type="radio" name="iva" id="iva0" value="0 %" >   0 %</label> 
                <label><input type="radio" name="iva" id="iva12" value="12%" > 12%</label>
           </div>
           </div>
           
                <label><input type="hidden" name="precio_iva" id="precio_iva"  ></label>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-success" onclick="update_producto();">Actualizar</button>
        </div>
      </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
  </div><!-- /.modal -->
